...
/**
* <h1>Desperate Girls Class</h1>
* <p> This class contains basic information about Desperate Girl and methods to retrieve those information .</p>
...
public class desperateGirl extends Girls{
    ...
    /**
     * <p>Constructor to initialise attributes for Desperate Girl's Object by calling super class constructor</p>
    ...
    public desperateGirl (String name, int type,  int attractiveness, int intelligence, int maintenance, int criterion) {
    ...
    public double calHappiness () {
        return Math.exp((double)(getTotalGiftCostAchieved() /getMaintenance()));
    }
}
