...
package model;
/**
* <h1>Choosy Girls Class</h1>
* <p> This class contains basic information about Choosy Girl and methods to retrieve those information .</p>
...
public class choosyGirl extends Girls{
    ...
    /**
     * <p>Constructor to initialise attributes for Choosy Girl's Object by calling super class constructor</p>
    ...
    public choosyGirl (String name, int type,  int attractiveness, int intelligence, int maintenance, int criterion) {
    ...
    public double calHappiness () {
        return Math.log((double)(getTotalGiftCostAchieved() / getMaintenance()));
    }
}
