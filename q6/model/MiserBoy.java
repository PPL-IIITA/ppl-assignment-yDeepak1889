...
package model;
/**
* <h1>Miser Boy Class</h1>
* <p> This class contains basic information about Miser Boys and methods to retrieve those information.</p>
...
public class MiserBoy extends Boys{
    ...
    /**
     * <p>Constructor to initialise attributes for Miser Boys Object by Calling Super class construtor</p>
    ...
    public MiserBoy (String name, int type, int attractiveness, int intelligence,  int budget,  int minAttractiveness) {
    ...
    public double calHappiness () {
        return getBudget() - getSpentMoney();
    }
}
