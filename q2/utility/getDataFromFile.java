        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                if (dataArray.length == 3) {
                    giftsArray.add(new Gifts(Integer.parseInt(dataArray[0]), Integer.parseInt(dataArray[1]), Integer.parseInt(dataArray[2])));
                }else {
                    giftsArray.add(new Gifts(Integer.parseInt(dataArray[0]), Integer.parseInt(dataArray[1]), Integer.parseInt(dataArray[2]), Integer.parseInt(dataArray[3]), Integer.parseInt(dataArray[4])));
                }
            }
